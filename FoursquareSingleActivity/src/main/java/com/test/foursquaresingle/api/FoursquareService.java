...
public interface FoursquareService {
    ...
    // T
    //String FOURSQUARE_CLIENT_ID = "K1TDMR4U3QXQZAE2I4O1SILLJQ0TCVTJM3TTKGM2MVAJ5WTA";
    //  String FOURSQUARE_SECRET_ID = "MJPND4W1MKAAPOPMPL1C1ILEOKCC0CZO12RM5UW3MYLSEH0X";

    String BASE_URL = "https://api.foursquare.com";

    /**
     * Get venues near specified city or area with specified type. For example, bars near Rome
     *
