...
public class VenueSearchViewModel extends ViewModel {
    ...
    public VenueSearchViewModel(VenueRepository venueRepository) {
        ...
        it reacts on changes of trigger LiveData, applies the given function to new value of trigger LiveData and sets resulting LiveData as a "backing" LiveData to swLiveData.
         */

        // Note: this required to attach same LiveData instance to required fragment or activity
