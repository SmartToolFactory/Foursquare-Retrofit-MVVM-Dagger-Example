...
/**
 * RecyclerView Adapter with data binding to display venues as a list in {@link com.test.foursquaremultiple.venuelist.VenueListFragment}
 */
public class VenueAdapter extends RecyclerView.Adapter<VenueAdapter.VenueViewHolder> {
    ...
    public VenueViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewDataBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.custom_row_venue, parent, false);
